    ...
    <nav
        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <Link :href="route('admin.dashboard')" class="flex items-center justify-between mr-5">
                    <!-- <img class="avatar" :src="$page.props.auth.user.avatar ? ('storage/' + $page.props.auth.user.avatar) : ('storage/avatars/logo.png')" alt=""> -->
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white ml-3">CSGH - SRS</span>
                </Link>
            </div>
